...
/***/ function(module, exports, __webpack_require__) {
	...
	var createChatConsole = __webpack_require__(2);
	var initializeView    = __webpack_require__(10);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createComponent     = __webpack_require__(3);
	var _createDivComponent = __webpack_require__(5);
	var DIV                 = __webpack_require__(6).DIV;
	var H1                  = __webpack_require__(6).H1;
	var P                   = __webpack_require__(6).P;
	...
	/*
	var users = {}; // with style, id, name // chattee? currentUser?
	...
	div id=spa
	  div class=spa-shell-head
	    ...
	    div class=spa-shell-head-acct>secundus12</>
	  div class=spa-shell-main
	    div class=spa-shell-main-nav
	      div class=spa-avtr-box spa-x-is-user
	          data-id="5800448895d827132315c186"
	          title="secundus12"
	          style="top: 25px; left: 25px; background-color: rgb(136, 255, 136);">
	            secundus12</>
	...
	SPA(
	  HEAD(
	    LOGO(
	      _H1('SPA'),
	      _P('javascript end to end'),
	      ACCOUNT(user.name))),
	  MAIN(
	    NAV(
	      users.map(getAvatarBox)),
	    CONTENT()),
	  FOOT(),
	  MODAL(),
	  createChatConsole(config));
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(8)('text');
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(8)('submit');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createElement = __webpack_require__(11).createElement;
